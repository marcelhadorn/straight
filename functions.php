<?php
/**
 * straight functions and definitions
 *
 * @package straight
 */
...
function straight_setup() {
	 ...
	 * If you're building a theme based on straight, use a find and replace
	 * to change 'straight' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'straight', get_template_directory() . '/languages' );
	...
	add_theme_support( 'custom-background', apply_filters( 'straight_custom_background_args', array(
 ...
 */
function straight_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'straight' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', 'straight_widgets_init' );
